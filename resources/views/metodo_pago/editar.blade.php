...
@section('datosPlataforma')
    ...
    <div class="authentication-wrapper authentication-6 px-5">
        <div class="authentication-inner py-4">
            <h3 class="font-weight-bold py-3 mb-0">Editar método de pago</h3>
            <div class="text-muted small mt-0 mb-4 d-flex justify-content-between align-items-center">
                <div class="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item active">Editar método de pago</li>
                    </ol>
                </div>
            </div>

            <form class="my-1" method="POST" action="{{ route('actualizar-metodo-pago', $metodoPago->id) }}">
                @method('PUT')
                @csrf
                <div class="row justify-content-center">
                    <div class="form-group col-md">
                        ...
                        <input type="text" class="form-control @error('medio_pago') is-invalid @enderror"
                            id="medioPagoInput" name="medio_pago" value="{{ $metodoPago->medio_pago }}">
                        @error('medio_pago')
