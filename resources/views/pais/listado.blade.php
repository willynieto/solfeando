...
@section('datosPlataforma')
    ...
    <div class="layout-content">
        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <h3 class="font-weight-bold py-3 mb-0">Maestro de paises</h3>
            <div class="text-muted small mt-0 mb-4 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('registro-pais') }}" class="btn btn-success feather icon-flag"><strong>+</strong></a>
            </div>
            ...
            <div class="card table table-responsive p-3">
                <table id="paises" class="table card-table">
                    ...
                    <tbody>
                        @foreach ($paises as $pais)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('editar-pais', $pais->id) }}"
                                        class="btn btn-warning feather icon-edit-1 m-1" style="display: inline-block;"></a>
                                    <form method="POST" action="{{ route('eliminar-pais', $pais->id) }}"
