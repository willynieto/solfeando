...
@section('datosPlataforma')
    ...
    <div class="authentication-wrapper authentication-6 px-5">
        <div class="authentication-inner py-4">
            <h3 class="font-weight-bold py-3 mb-0">Editar rol</h3>
            ...
            <form class="my-1" method="POST" action="{{ route('actualizar-rol', $rol->id) }}">
                @method('PUT')
                @csrf
                <div class="row justify-content-center">
                    <div class="form-group col-md">
                        ...
                        <input type="text" class="form-control @error('nombre_rol') is-invalid @enderror"
                            id="nombreRolInput" name="nombre_rol" value="{{ $rol->nombre_rol }}">
                        @error('nombre_rol')
